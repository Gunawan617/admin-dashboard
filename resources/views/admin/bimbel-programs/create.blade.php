...
<div class="container mx-auto max-w-4xl">
    <h1 class="text-3xl font-bold mb-6">Tambah Bimbel Program</h1>
    <form action="{{ route('admin.bimbel-programs.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
        @csrf
